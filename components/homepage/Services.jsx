  ...
  return (
    <div className="w-full flex items-center justify-between gap-[40px] max-w-[1210px] mx-auto my-[30px]">
      <div className="w-[35%] flex flex-col gap-[20px]">
        <h2 className="text-[28px] text-blue-900 font-medium">
        ...
        <Link
          href="/"
          className="text-white bg-[#ff6600] mt-[45px] w-1/2 text-center px-4 py-3 rounded-full"
        >
          REQUEST QUOTE
        </Link>
      </div>
      <div className="w-[65%] grid grid-cols-3 gap-x-9 gap-y-5">
        {[...Array(9)].map((item, i) => (
          <div
            key={i}
            className="w-full shadow-md shadow-[#888] flex gap-5 h-[95px] transition-all duration-200 ease-in-out group"
          >
            <div className="w-[65px] border-[2px] border-l-0 border-[#504c4c] flex items-center justify-center rounded-r-full bg-white group-hover:bg-[#ff6600] transition-colors duration-200 ease-in-out">
              <i className="flaticon-support text-[40px] ml-[-6px] text-blue-900 group-hover:text-white"></i>
            </div>
