...
export default function Allservicecards(props) {
  ...
  return !videos ? (
    <div className="w-[340px]  fromleft">
      <div className="allservicecard w-full relative z-[0]"></div>
      <div
        className="relative px-[26px] z-10 w-full h-full allservicecard hover:scale-105 duration-500"
        style={{
        ...
        <div className="mt-[15px] z-20 relative w-[100%] flex flex-col gap-[30px]">
          ...
          <button className="mt-[10px]">
            <Link
              ...
              className="border border-[#f60] bg-[#f60] hover:border-[#fff] tracking-tight  hover:text-[#333] hover:bg-white uppercase font-roboto  text-[16px] float-right right-[0px] absolute bottom-4 font-mediuum text-white duration-400 px-2 py-[2px] rounded"
            >
              {data.button}
            </Link>
          </button>
    ...
    <div className="w-[90%] rounded-t-[13px]  border-2  my-[30px]">
